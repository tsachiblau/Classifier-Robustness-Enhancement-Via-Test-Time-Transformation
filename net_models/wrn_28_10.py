...
class WideResNet(nn.Module):
    def __init__(self, depth=28, width=10, num_classes=10, mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5), dropout_rate=0.0):
        super(WideResNet, self).__init__()
        self.in_planes = 16
        self.mean = torch.Tensor(mean).cuda().view(3, 1, 1)
        self.std = torch.Tensor(std).cuda().view(3, 1, 1)
